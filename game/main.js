...
class Game {
    ...
    loadObjects() {
        ...
        this.board = new Board(this.scene, this.world, '../game/assets/wood_texture.jpeg');
        this.sphere = new Sphere(this.scene, this.world, metalNormal, metalTexture, true);
    ...
    onMouseMove(event) {
        ...
        const gravityX = (event.clientX / window.innerWidth - 0.5) * this.gravityStrength;
        const gravityY = -(event.clientY / window.innerHeight - 0.5) * this.gravityStrength;
